...
namespace Tebak_Kata
{
    class Program
    {
        ...
        static String kataMisteri = "brenford";
        ...
        static void Intro(){ 
             ...
             Console.WriteLine("Petunjuknya adalah kata ini merupakan  ");
             Console.WriteLine("Pentunjuknya adalah kata ini merupakan nama club sepakabola");
             Console.WriteLine($"Kata tersebut terdiri dari {kataMisteri.Length} huruf");
             Console.WriteLine("club apa yang dimaksud?");
             Console.ReadKey();
             Console.WriteLine();   
